...
HD_PWD='P:/CS214-Computer-Organization/Lab/lab10/v/v.runs/dmem_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dmem.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dmem.tcl
